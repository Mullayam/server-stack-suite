...
const steps = [
  { label: "Introduction", icon: <Circle size={15} /> },
  { label: "Personal Information", icon: <Circle size={15} /> },
  { label: "Address Details", icon: <Circle size={15} /> },
  { label: "Review & Submit", icon: <Circle size={15} /> },
];
