  ...
  return (
    ...
    <div className="xl:w-0 xl:flex-1">
      ...
      <p className="max-w-3xl mt-3 text-lg leading-6 text-indigo-200">
        No account or email required. We use push notifications. You can choose
        between several modes and define your own alert threshold.
      </p>
    </div>
    <div className="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
      ...
      <p className="text-sm leading-5 text-indigo-200">
        In order to receive the notifications, you must give permission sufficient
        to your web browser.
      </p>
    </div>
  </div>
