...
const RulesCard = () => {
  ...
  <div className="flex w-[38rem] flex-col rounded-2xl bg-white px-6 shadow-2xl sm:px-14">
    ...
    <div className="flex w-full flex-col pb-8 pt-4">
      ...
      <div className="my-4 space-y-3">
        ...
        <label htmlFor="marketing" className="flex space-x-4">
          <input
            ...
            className="h-6 w-6 shrink-0 accent-gray-900"
          />
          <span id="marketing-description" className="text-sm text-gray-600">
      ...
      <p className="my-2 text-center text-sm font-medium text-gray-900">
